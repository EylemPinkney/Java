...
public class StringBuilder01 {
    ...
    /*
        ...
        3)StringBuilder is NOT "thread-safe" and is NOT "synchronized" == StringBuilder cant do multiple tasks at the same time
        and cant select appropriate order for "multi thread"
    ...
    public static void main(String[] args) {
       ...
       //start counts on indexes
        ...
        // remember to mention about reverse() method in StringBuilder Class

        sb1.reverse();
        System.out.println(sb1);//...! si avaJ

        //toString(); is for converting "StringBuilder" to "String", but toString();
        // method does not change the structure of original "StringBuilder"
