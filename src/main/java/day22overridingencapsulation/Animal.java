...
public class Animal {
    ...
    /*
        ...
        2)"Method Signature"(Method Name and Method Parameters) must be same in "Method Overriding"
         Method Name and Method Parameters in parent and child class must be the same.
        3)The method in child class(Overriding Method) can use "same" or "wider" access modifier than the
        ...
        11)"static" method cannot be overridden
            ...
            3)"final" keyword can be used for methods
              ...
              The body of a "final method" cannot be updated, so it cannot be overridden
              because in overriding we update the method body

         12) Polymorphism = Method Overloading + Method Overriding
         What is the difference between "Method Overloading" and "Method Overriding"?
            i)"Method Overriding" needs "inheritance" but "Method Overloading" occurs in a single class
            we do not need "inheritance"
            ii)"private" methods cannot be overridden but can be overloaded
            iii)We do not touch "method signature" in "Method Overriding" but we change "parameters"
            I mean method signature in "Method Overloading"
