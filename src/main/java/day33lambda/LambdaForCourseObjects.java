...
public class LambdaForCourseObjects {
    ...
    public static void main(String[] args) {
        ...
        /*
        Functional programming uses Collections. We created above are objects and we will create a List and put those objects into the list
        and then I'll use the List in functional programming.
         */
        List<Course> courses = new ArrayList<>();
        /*
        We used Course as a data type here because data type of the object : eg "courseTurkishDay" is Course. --> Course courseTurkishDay
         */
