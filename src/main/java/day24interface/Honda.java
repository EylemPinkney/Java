...
public class Honda implements Ac, Engine {
    ...
    /*
        ...
        6)Interfaces are "fully abstract", they can ONLY have abstract methods,
          and "Interfaces" cannot have concrete methods, all methods in an interface
          must be abstract method. As you know "abstract methods" must be implemented by "concrete child classes",
          If you want a developer not to forget any "mandatory functionalities" to implement for a child class,
          using interfaces is perfect. We name an interface as "To do list" for the child classes
        ...
        8)Methods in an interface are "public" and "abstract", that is why no need
        to type "public" and "abstract" when you create a method
        ...
        9)Interfaces do not have "constructor" that is why you cannot create object from an interface.
          ...
          As a summary; abstract structures cannot give you objects.

        10)Do not make an "abstract method" "static" because, "static" methods cannot be overridden
        but "abstract methods" are created to override. So do not try to make any method in an interface "static"
        ...
        12)We have two options to create a concrete method in interfaces. You can use default keyword for regular methods.
        YOu need to create an object to call this method. And you can use static keyword and you can call this method
        with interface name.

           *** Interview question: Differences btw abstract classes and interfaces *** Very common interview question.
