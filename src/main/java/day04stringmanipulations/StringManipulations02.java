...
public class StringManipulations02 {
    ...
    public static void main(String[] args) {
        ...
        /*
        We dont use == for String because of the senario 3
         */


         /*
        Methods we learned today;

        split() - splits the input from where the space is
        charAt()
        legnth()
        toUpperCases ()
        toLowercases ()
        trim () - remove spaces from begining and end
        substring ()
        equals () -
        equalsIgnoreCase () -
        startsWith () -
