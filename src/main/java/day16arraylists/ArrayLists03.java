...
public class ArrayLists03 {
    ...
    public static void main(String[] args) {
        ...
        //Although you can't add and remove elements from your list, you can do so many other methods that you cant do if it was am Array.
        ...
        /*
        Lists are more advanced than Arrays.
        Method names summarise the functionilty.
