    ...
    */
    ...
    public static void calculateAverage(String stdName, double ... mark){
        ...
        System.out.println(stdName + "'s Average of exams: " + String.format("%.3f", sum/ mark.length));
                ...
                /*
        String.format(format:"%.2") ----> This is formatting to see only two digits for decimal points. Add "f" if there is a
         format We can format ==> String.format("%.2f", sum/ mark.length));
         */
